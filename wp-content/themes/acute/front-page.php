...
<?php if (is_404()) { } else { //HIDE HEADER FOR 404 PAGE ?>
	...
	<div id="header" class="row animated BeanFadeIn">
 	...
 	<header style="background-color: none;"
 				   class="clear animated BeanFadeIn">
		...
		<p style="font-family: 'Source Sans Pro';
							     ...
							     line-height: 30px;
							     ">
							      	<img src = "http://localhost:8888/wp-content/uploads/logo-placeholder-main.png" />
						...
						<p style = "color: #0988bb;
									font-size: 21px;
									line-height: 35x;">
						A project by the United Nations Office for the Coordination of Humanitarian Affairs to make humanitarian data easily available and useful for decision making.
						</p>

						<!-- Network Image -->

						<!-- <img src = "http://localhost:8888/wp-content/uploads/background-front-page.png" /> -->
